...
#part_attention_vit,local_attention_vit
feat_dim_dict = {
...
def build_loss(cfg, num_classes):
    ...
    if cfg.MODEL.IF_LABELSMOOTH == 'on':
        if name == 'part_attention_vit' and cfg.MODEL.PC_LOSS:#part_attention_vit,local_attention_vit
    ...
    # softmax & triplet
        ...
        def loss_func(score, feat, target, domains=None, t_domains=None, all_posvid=None, soft_label=False, soft_weight=0.1, soft_lambda=0.2):
            if cfg.MODEL.METRIC_LOSS_TYPE == 'triplet':
                if cfg.MODEL.IF_LABELSMOOTH == 'on':
                    if name == 'part_attention_vit' and cfg.MODEL.PC_LOSS:
